...
(
  ...
  CONSTRAINT giz_alertas_pk PRIMARY KEY (id_alertas)
)
...
ALTER TABLE giz.giz_municipalidad RENAME COLUMN id_tipo_municipalidad TO id_tipo_municipalidad;
--
...
(
    id_parametro serial,
    nombre_parametro character varying(50) COLLATE pg_catalog."default" NOT NULL,
    glosa_parametro character varying(20) COLLATE pg_catalog."default" NOT NULL,
...
CREATE TABLE giz_tipomunicipalidad (
    id_tipomunicipalidad integer NOT NULL,
...
ALTER TABLE giz.giz_tipomunicipalidad RENAME COLUMN nombre_tipomunicipalidad TO nombre_tipo_municipalidad;
--
