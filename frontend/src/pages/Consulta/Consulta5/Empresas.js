...
export const options = {
    ...
    title: {
        text: 'Vehiculos para cobro de subsidio'
    },
    xAxis: [{
        categories: [],
        crosshair: true
...
export default function Empresas({ consultaId, handleClickEmpresa }) {
    ...
    useEffect(() => {
        const getEmpresas = async () => {
            ...
            chartOptions.title.text = `Reporte de Vehículos que cumplen con kilómetros válidos para Subsidio, por Empresas de Transporte registradas`;
