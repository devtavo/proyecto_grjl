...
export const options = {
    ...
    title: {
        text: 'Ranking De Kilometros Recorridos Por Vehículos En Servicio'
    },
    xAxis: [{
        categories: [],
        crosshair: true
...
export default function Empresas({ consultaId, handleClickEmpresa }) {
    ...
    useEffect(() => {
        const getEmpresas = async () => {
            ...
            chartOptions.title.text = `Ranking De Kilometros Recorridos Por Vehículos En Servicio`;
    ...
    const columnsDet = [
        {
            Header: 'Ranking De Kilometros Recorridos Por Vehículos En Servicio',
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
