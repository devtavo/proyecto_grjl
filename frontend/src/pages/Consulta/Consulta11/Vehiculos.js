...
export default function Vehiculos({ consultaId, empresaId, rutaId, inicio, final, codigoRuta, razonSocial, setShowVehiculos }) {
    ...
    useEffect(() => {
        const getVehiculos = async () => {
            ...
            chartOptions.title.text = `Ranking De Kilometros Recorridos Por Vehículos En Servicio de la ruta ${codigoRuta} de la empresa ${razonSocial} desde el ${inicio} al ${final}`;
    ...
    const columnsDet = [
        {
            Header: `Ranking De Kilometros Recorridos Por Vehículos En Servicio de la ruta ${codigoRuta} de la empresa ${razonSocial} desde el ${inicio} al ${final}`,
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
