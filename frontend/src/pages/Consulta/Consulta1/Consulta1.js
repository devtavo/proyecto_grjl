...
export default function Consulta1({ consultaId }) {
    ...
    if (vista === VISTA_EMPRESAS)
        return (
            <>
                ...
                {/* <Navigation
                    title="REPORTE COMPARATIVO DIAS, SEMANAS Y MESES"
    ...
    //             <Navigation
    //                 title="Kilómetros recorridos por los vehículos en servicio"
    //                 breadcrumb={breadCrumb}
    //             />
    //             <Breadcrumb 
    //                 title='Nivel Rutas'
    ...
    //             <Navigation
    //                 title="Kilómetros recorridos por los vehículos en servicios"
    //                 breadcrumb={breadCrumb}
    //             />
    //             <Breadcrumb 
