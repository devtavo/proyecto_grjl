...
export const options = {
    ...
    title: {
        text: 'Cantidad De Kilómetros Recorridos En Servicio De Los Vehículos De Transporte'
    },
    xAxis: [{
        categories: [],
        crosshair: true
    ...
    series: [
        {
            name: 'Cantidad de Kilómetros recorridos',
            type: 'column',
            data: [],
            tooltip: {
                valueSuffix: ' km'
...
export default function Empresas({ consultaId, handleClickEmpresa }) {
        ...
        const getEmpresas = async () => {
            ...
            const total =
                [{
                    ...
                    kmRecorridos: getTotals(empresas.data.detalle, 'kmRecorridos'),
            ...
            chartOptions.title.text = `Cantidad De Kilómetros Recorridos En Servicio De Los Vehículos De Transporte`;
    ...
    const columnsDet = [
        {
            Header: 'Cantidad De Kilómetros Recorridos En Servicio De Los Vehículos De Transporte',
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
