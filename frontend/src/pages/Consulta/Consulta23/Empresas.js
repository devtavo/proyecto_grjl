...
export const options = {
    ...
    title: {
        text: 'Ranking De Vehículos Con Mayor Kilometraje Dentro De Ruta Por Rango De Fecha'
    },
    xAxis: [{
        categories: [],
        crosshair: true
    ...
    series: [
        {
            name: 'Max. Kilómetros recorridos',
            type: 'column',
            data: [],
            tooltip: {
                valueSuffix: ' km'
...
export default function Empresas({ consultaId, handleClickEmpresa }) {
    ...
    useEffect(() => {
        const getEmpresas = async () => {
            ...
            chartOptions.title.text = `Ranking De Vehículos Con Mayor Kilometraje Dentro De Ruta Por Rango De Fecha`;
    ...
    const columnsDet = [
        {
            Header: 'Ranking De Vehículos Con Mayor Kilometraje Dentro De Ruta Por Rango De Fecha',
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
                ...
                {
                    Header: 'Max. Kilómetros Recorridos',
