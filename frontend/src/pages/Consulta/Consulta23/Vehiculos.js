...
export default function Vehiculos({ consultaId, empresaId, rutaId, inicio, final, codigoRuta, razonSocial, setShowVehiculos }) {
    ...
    useEffect(() => {
        const getVehiculos = async () => {
            ...
            chartOptions.title.text = `Ranking De Vehículos Con Mayor Kilometraje Dentro De Ruta Por Rango De Fecha de la ruta ${codigoRuta} de la empresa ${razonSocial} desde el ${inicio} al ${final}`;
    ...
    const columnsDet = [
        {
            Header: `Ranking De Vehículos Con Mayor Kilometraje Dentro De Ruta Por Rango De Fecha de la ruta ${codigoRuta} de la empresa ${razonSocial} desde el ${inicio} al ${final}`,
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
