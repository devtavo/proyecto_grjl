...
export default function Consulta12({ consultaId }) {
    ...
    if (vista === VISTA_EMPRESAS)
        return (
            <>
                ...
                <Navigation
                    title="Cantidad momentos de vehículos por rango de velocidad por día por semana por tabla con baremos"
    ...
    if (vista === VISTA_VEHICULOS)
        return (
            <>
                <BackButton handleClickBack={handleClickBack} />
                <Navigation
                    title="Cantidad de vehículos por rango de velocidad por día por semana por tabla con baremos"
                    breadcrumb={breadCrumb}
                />
                <Breadcrumb 
