...
export const options = {
    ...
    title: {
        text: 'Pago De Subsidio Por Kilometros Recorridos En Servicio'
    },
    xAxis: [{
        categories: [],
        crosshair: true
...
export default function Empresas({ consultaId, handleClickEmpresa }) {
    ...
    useEffect(() => {
        const getEmpresas = async () => {
            ...
            const pagoSubsidio = empresas.data.detalle.reduce((acc, { pagoSubsidio }) => (acc.push(parseInt(pagoSubsidio)), acc), []);

            chartOptions.title.text = `Pago De Subsidio Por Kilometros Recorridos En Servicio`;
    ...
    const columnsDet = [
        {
            Header: 'Pago De Subsidio Por Kilometros Recorridos En Servicio',
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
