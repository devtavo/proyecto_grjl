...
export default function Rutas({ consultaId, empresaId, razonSocial, inicio, final, handleClickRuta }) {
        ...
        const getRutas = async () => {
            ...
            const total =
                [{
                    ...
                    pagoSubsidio: getTotals(rutas.data.detalle, 'pagoSubsidio')                }];
            ...
            const pagoSubsidio = rutas.data.detalle.reduce((acc, { pagoSubsidio }) => (acc.push(parseInt(pagoSubsidio)), acc), []);

            chartOptions.title.text = `Pago De Subsidio Por Kilometros Recorridos En Servicio de la empresa ${razonSocial} desde el ${inicio} al ${final}`;
    ...
    const columnsDet = [
        {
            Header: `Pago De Subsidio Por Kilometros Recorridos En Servicio de la empresa ${razonSocial}`,
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
