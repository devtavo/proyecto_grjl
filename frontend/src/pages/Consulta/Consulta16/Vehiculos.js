...
export default function Vehiculos({ consultaId, empresaId, rutaId, inicio, final, codigoRuta, razonSocial, setShowVehiculos }) {
    ...
    useEffect(() => {
        const getVehiculos = async () => {
            ...
            chartOptions.title.text =  `Pago De Subsidio Por Kilometros Recorridos En Servicio de la empresa ${razonSocial} de la ruta ${codigoRuta} desde el ${inicio} al ${final}`;
    ...
    const columnsDet = [
        {
            Header: `Pago De Subsidio Por Kilometros Recorridos En Servicio de la empresa ${razonSocial} de la ruta ${codigoRuta} desde el ${inicio} al ${final}`,
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
