...
export default function Rutas({ consultaId, empresaId, razonSocial, inicio, final, handleClickRuta }) {
        ...
        const getRutas = async () => {
            ...
            const total =
                [{
                    ...
                    vehiculos: getTotals(rutas.data.detalle, 'vehiculos')
                }];
            ...
            const vehiculos = rutas.data.detalle.reduce((acc, { vehiculos }) => (acc.push(parseInt(vehiculos)), acc), []);
            ...
            chartOptions.title.text = `Tiempos De Recorrido Entre Paraderos Y Rutas Completadas Por Vehículo`;
    ...
    const columnsDet = [
        {
            Header: `Tiempos De Recorrido Entre Paraderos Y Rutas Completadas Por Vehículo de la empresa ${razonSocial}`,
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
                ...
                {
                    Header: 'Total Tiempo de vehiculos en la ruta (días y horas)',
