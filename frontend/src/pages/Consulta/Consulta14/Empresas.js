...
export const options = {
    ...
    title: {
        text: 'Tiempos de vehiculos dentro de la ruta'
    },
    xAxis: [{
        categories: [],
        crosshair: true
...
export default function Empresas({ consultaId, handleClickEmpresa }) {
    ...
    const columnsDet = [
        {
            Header: 'Tiempos De Recorrido Entre Paraderos Y Rutas Completadas Por Vehículo',
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
                ...
                {
                    Header: 'Total Tiempo vehiculos en la ruta (días y horas)',
