...
export const options = {
    ...
    title: {
        text: 'Promedio De Kilómetros Recorridos En Servicio De Los Vehículos De Transporte'
    },
    xAxis: [{
        categories: [],
        crosshair: true
    ...
    series: [
        {
            name: 'Promedio de Kilómetros recorridos',
            type: 'column',
            data: [],
            tooltip: {
                valueSuffix: ' km'
...
export default function Empresas({ consultaId, handleClickEmpresa }) {
    ...
    useEffect(() => {
        const getEmpresas = async () => {
            ...
            chartOptions.title.text = `Promedio De Kilómetros Recorridos En Servicio De Los Vehículos De Transporte`;
    ...
    const columnsDet = [
        {
            Header: 'Promedio De Kilómetros Recorridos En Servicio De Los Vehículos De Transporte',
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
                ...
                {
                    Header: 'Promedio Kilómetros Recorridos',
