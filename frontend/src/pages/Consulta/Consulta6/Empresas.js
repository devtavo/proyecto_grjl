...
export const options = {
    ...
    title: {
        text: 'Excesos de velocidad en las Empresas de Transporte del Sistema'
    },
    xAxis: [{
        categories: [],
        crosshair: true
    ...
    series: [
        {
            name: 'Excesos de velocidad en ruta',
            type: 'column',
            yAxis: 1,
            data: []
        },
        {
            name: 'Excesos de velocidad fuerta de ruta',
            type: 'column',
            yAxis: 1,
            data: []
        },
        {
            name: 'Porcentaje de excesos fuera de ruta',
            type: 'spline',
            data: [],
            tooltip: {
                valueSuffix: '%'
...
export default function Empresas({ consultaId, handleClickEmpresa }) {
    ...
    useEffect(() => {
        const getEmpresas = async () => {
            ...
            chartOptions.title.text = `Excesos de velocidad en las Empresas de Transporte del Sistema`;
    ...
    const columnsDet = [
        {
            Header: 'Porcentaje de excesos de velocidad en las Empresas de Transporte del Sistema',
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
