...
export default function Rutas({ consultaId, empresaId, razonSocial, inicio, final, handleClickRuta }) {
    ...
    useEffect(() => {
        const getRutas = async () => {
            ...
            chartOptions.title.text = `Promedio de tiempos De Recorrido Entre Paraderos Y Rutas Completadas Por Vehículo`;
    ...
    const columnsDet = [
        {
            Header: `Promedio de tiempos De Recorrido Entre Paraderos Y Rutas Completadas Por Vehículo de la empresa ${razonSocial}`,
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
