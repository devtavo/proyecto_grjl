...
export const options = {
    ...
    title: {
        text: 'VEHÍCULOS EN SERVICIO vs VEHÍCULOS AUTORIZADOS'
    },
    xAxis: [{
        categories: [],
        crosshair: true
...
export default function Empresas({ consultaId, handleClickEmpresa }) {
    ...
    const columnsDet = [
        {
            Header: 'VEHÍCULOS EN SERVICIO vs VEHÍCULOS AUTORIZADOS',
            columns: [
                {
                    Header: '#',
                    accessor: 'id',
                    ...
                    Cell: (props) => {
                        ...
                        return (
                            <Link href="#" underline="none" onClick={(e) => {
                                handleClickEmpresa(e, id, fechaInicio.toLocaleDateString().split('/').join('-'), fechaFin.toLocaleDateString().split('/').join('-'), razonSocialEmpresa)
                            }}>
                                {razonSocialEmpresa}
                            </Link>
                        );
