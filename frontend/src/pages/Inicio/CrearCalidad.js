...
export default function CrearCalidad({ formulario, initialValues, onSuccess, onError }) {
                    ...
                    <Grid item xs={formulario === CREAR_REGISTRO ? 12 : initialValues.origen === 'M' ? 12 : 6}>
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            <FormControl fullWidth margin="dense">
                                <InputLabel id="razonSocialEmpresa">Razon Social Empresa</InputLabel>
                                <Select
                                    defaultValue={formik.values.razonSocialEmpresa}
                                    labelId="razonSocialEmpresa"
                                    id="razonSocialEmpresa"
                                    name="razonSocialEmpresa"
                                    label="Razon Social Empresa"
                                    onChange={formik.handleChange}
                                >
                                    <MenuItem value={1}>Chancadora</MenuItem>
                                    <MenuItem value={2}>Disposicion</MenuItem>
                                </Select>
                                {formik.errors.razonSocialEmpresa}
                            </FormControl>
                            <TextField
                                autoFocus
                                fullWidth
