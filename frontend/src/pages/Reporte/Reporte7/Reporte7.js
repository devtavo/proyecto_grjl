...
export default function Reporte7({ reporteId }) {
    ...
    if (vista === VISTA_EMPRESAS)
        return (
            <>
                ...
                <Navigation
                    title="	Cumplimiento de las detenciones de vehículos en paraderos establecidos"
    ...
    if (vista === VISTA_RUTAS)
        return (
            <>
                ...
                <Navigation
                    title="Cumplimiento del plan de rutas"
                    breadcrumb={breadCrumb}
                />
                <Breadcrumb 
                    title='Nivel Rutas'
